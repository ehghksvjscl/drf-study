...
@pytest.mark.parametrize(
    ("allowed_origin, origin_header, expect_connected"), [
...
@pytest.mark.asyncio
async def test_origin_validator_settings(allowed_origin, origin_header, expect_connected):
    application = OriginValidator(AsyncWebsocketConsumer(), allowed_origin)
